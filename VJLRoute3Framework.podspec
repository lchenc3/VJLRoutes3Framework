#
#  Be sure to run `pod spec lint VJLRoute3Framework.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "lchence"
  # s.authors            = { "lchence" => "chenlaifang@gmail.com" }
  # s.social_media_url   = "http://twitter.com/lchence"
  ...
  s.source       = { :git => "https://github.com/lchenc3/VJLRoutes3Framework.git", :tag => "1.0.0" }
